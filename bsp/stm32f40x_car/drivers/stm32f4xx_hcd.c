...
ALIGN(4) USB_OTG_CORE_HANDLE USB_OTG_Core;
ALIGN(4)  USBH_HOST USB_Host;
 ...
 */
int susb_control_xfer(uinst_t uinst, ureq_t setup, void* buffer, 
 ...
 * @return the error code, RT_EOK on successfully.
 */
rt_err_t susb_alloc_pipe(upipe_t* pipe, uifinst_t ifinst, uep_desc_t ep, 
...
{    
    ...
    USBH_DeAllocate_AllChannel(&USB_OTG_Core);  
    /* Enable Interrupts */
    USB_OTG_FS_EnableInterrupt(&USB_OTG_Core);    
